...
IF NOT EXIST %model_checkpoint_path% (
    ...
    powershell -command "Invoke-WebRequest -Uri https://ggml.ggerganov.com/ggml-model-whisper-large-q5_0.bin -OutFile .\model\ggml-model-whisper-large-q5_0.bin" 
    powershell -command "Invoke-WebRequest -Uri https://ggml.ggerganov.com/ggml-model-whisper-medium-q5_0.bin -OutFile .\model\ggml-model-whisper-medium-q5_0.bin" 
    powershell -command "Invoke-WebRequest -Uri https://ggml.ggerganov.com/ggml-model-whisper-small-q5_1.bin -OutFile .\model\ggml-model-whisper-small-q5_1.bin" 
    powershell -command "Invoke-WebRequest -Uri https://ggml.ggerganov.com/ggml-model-whisper-medium.en-q5_0.bin -OutFile .\model\ggml-model-whisper-medium.en-q5_0.bin" 
)
ECHO.
